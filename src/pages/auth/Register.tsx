...
export default function Register() {
  ...
  const handleRequirementsPassword = () => {
    ...
    setRequirements((state) => ({
      ...
      specialCharacterRequirements: verifyCharacter.test(user.password)
        ? true
        : false,
      samePasswordRequeriments:
        user.password === user.passwordAgain ? true : false,
    }));
  };
  ...
  return (
    ...
    >
      <header className="w-screen flex justify-center items-center text-center gap-10 p-5">
        <h1 className="font-bold md:text-3xl uppercase ">
          SignUp - Stock Manager
        </h1>
      ...
      >
        <form
          ...
          className={
            theme == "light"
              ? "relative bg-slate-300 w-[98vw] md:w-[30vw] flex flex-col gap-2 m-auto justify-center p-5 md:p-10 border rounded-xl "
              : "relative w-[98vw] md:w-[30vw] flex flex-col gap-2 m-auto justify-center p-5 md:p-10 border rounded-xl "
          }
        >
          {erroMessage && <AlertAuth content={erroMessage} />}
          {showSucessAlert && (
            <AlertSucess message="Usuário cadastrado com sucesso!" />
          )}
          ...
          {showRequirements && (
            <div className="text-sm">
              ...
              <ul>
                <li
                  className={
                    requirements.lengthRequirements
                ...
                <li
                  className={
                    requirements.uppercaseRequirements
                      ? "text-green-600 flex items-center gap-2"
                      : "flex items-center gap-2"
                  }
                >
                ...
                <li
                  className={
                    requirements.lowercaseRequirements
                      ? "text-green-600 flex items-center gap-2"
                      : "flex items-center gap-2"
                  }
                >
                ...
                <li
                  className={
                    requirements.specialCharacterRequirements
                      ? "text-green-600 flex items-center gap-2"
                      : "flex items-center gap-2"
                  }
                >
                ...
                <li
                  className={
                    requirements.samePasswordRequeriments
                      ? "text-green-600 flex items-center gap-2"
                      : "flex items-center gap-2"
                  }
                >
